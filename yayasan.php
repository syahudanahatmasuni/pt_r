...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <form class="form-inline">
                <input class="form-control mr-sm-2" type="search" placeholder="Cari nama yayasan..." aria-label="Search">
    ...
    <div class="container">
        <div class="row" style="margin-top:20px;margin-bottom:60px;">
            <div class="col-sm text-center">
                <h1>Informasi Yayasan</h1>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="img/yayasan/yayasan1.jpg"  class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Rumah Singgah Bina Anak Pertiwi</h5>
                            <p class="card-text">Jumlah anak : 390 anak<br>
                                                Jumlah pengajar : 20 pengajar<br>
                                                Jumlah kelas : 8 kelas<br>
                                                Luas bangunan :	300 m2<br>
                                                Alamat : Jl. nin aja takut aja bisa jadi</p>
                        </div>
                </div>
            </div>
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="img/yayasan.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quae alias voluptate sit voluptas? Impedit illum molestiae quasi maxime, beatae reiciendis at amet error, dolorem tempora quo libero fugiat dicta facilis?</p>
                        </div>
                </div>
            </div>
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="img/yayasan.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique neque saepe possimus. Illo exercitationem pariatur, distinctio saepe libero atque nulla consectetur eius minima deserunt neque animi ullam, et, vitae architecto!</p>
                        </div>
                </div>
            </div>
        </div>            
    ...
    <div class="jumbotron jumbotron-fluid bg-primary" style="padding:0; margin-top:30px;">
        <div class="container">
            <div class="row">
